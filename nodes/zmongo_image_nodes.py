...
from .generic_helpers import (
    ...
    _parse_json_object,
    _success_payload,
    safe_get_by_path, _image_field_candidates, _pil_to_comfy_image, _document_key_summary, _find_first_bytes_envelope,
    _clean_field_path, _route_image_field_path, _decode_image_bytes_from_value,
)
